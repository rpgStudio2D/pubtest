<?php /* Smarty version Smarty-3.1.6, created on 2022-01-22 17:01:22
         compiled from "./Home/Tpl\Pubtest\test.html" */ ?>
<?php /*%%SmartyHeaderCode:977661eb9dd0121b47-04393310%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6a79d2040bb5634099d35ce13e0685c7e31f5e0' => 
    array (
      0 => './Home/Tpl\\Pubtest\\test.html',
      1 => 1642842073,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '977661eb9dd0121b47-04393310',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_61eb9dd01c8f9',
  'variables' => 
  array (
    'examsNum' => 0,
    'clicknum' => 0,
...
<?php if ($_valid && !is_callable('content_61eb9dd01c8f9')) {function content_61eb9dd01c8f9($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
...
<!-- 固定导航栏 -->
<div class="pubts_top">
    <h3><a href="__APP__">普 测 练 习</a></h3>
</div>
	...
	if( keyword == '' ){
		...
		$.ajax({
			...
			success:function(data){
				...
				//返回总数，和最近十条举报记录
				if( data.code == 200 ){
					ohtml= objToHtml( data.data, '<li><p class="retxt2" onclick="showDiv(\'{typeId}-{sn}\');">{sn}：{content}  <div id="exam{typeId}-{sn}" style="display:none;line-height:16px;" >【<font color="red">答案：<b>{answer}</b></font>】</div></p></li>');
					$('#rtlst_box').append(ohtml);
					//$('#rtlst_box').html(ohtml);onclick="this.display: block;"id="exam-{sn}"
				}
				else
...
function showDiv(id)
{
	var it=document.getElementById("exam"+id);
	it.style.display= ""; 
}
